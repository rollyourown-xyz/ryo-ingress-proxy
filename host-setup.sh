...
then
   echo "Host setup for ryo-service-proxy-discovery-config module has already been done on "$hostname""
   echo ""
else
   echo "Executing module-specific host setup playbooks for ryo-service-proxy-discovery-config on "$hostname""
   echo ""
