#------------------------------------------------------------------
# Packer template for building LXD container image for Consul
# as a component of the service registry and key-value store module
...
locals {
  ...
  build_playbook_file  = "${abspath(path.root)}/playbooks/provision-consul.yml"
